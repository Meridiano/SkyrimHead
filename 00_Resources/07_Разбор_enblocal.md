# Комплексный гайд по редактированию "enblocal.ini" — от команды S.T.E.P.
...
1) Скачайте инструмент [url=http://enbdev.com/download_vramsizetest.htm]VRamSizeTest[/url],
...
> В этой секции вы можете настроить эффект длинной выдержки. Возможный результат можно посмотреть [здесь](url=https://www.youtube.com/watch?v=OTrtDEjYKWU).
