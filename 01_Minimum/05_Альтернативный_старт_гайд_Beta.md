...
3) Установка должна проводиться вне области действия UAC (User Account Control). Можешь использовать другой локальный диск - D, E или где ты там держишь игрушки. Если ставишь пиратку, подойдёт "E:\Games", если из Стима - "E:\Steam Library". Поверь, это не спроста, в Program Files часто возникают проблемы с правами записи. Для гайда будем считать, что ты ставишь Скайрим из Стима.
...
9) Чтобы исправить это, сделай следующее:
    ...
    Вариант-1, стандартный.  
        1) возьми ярлык xEdit в МО с обычным набором аргументов (-tes5 -edit -l:russian -cp:1251).  
...
18) Убедись, что у тебя всё выглядит примерно так (если ты не выполнял пункты с 8 по 10, то у тебя не будет мода "Cleaned DLC", это нормально).
